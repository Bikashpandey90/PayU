...
const SignInPage = () => {
    ...
    // TOdo : define types
    const submitForm = async (data: { email: string, password: string, name: string, confirmPassword: string }) => {
        try {
            setloading(true);
            let payload = {
                name: data.name,
        ...
        <section className="min-h-screen bg-gray-50 flex flex-wrap">
            ...
            <div className="w-full lg:w-1/2 py-8 px-6 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full">
                    <div className="mb-8">
                        <a href="/" className="mb-10 text-2xl gap-3 flex font-extrabold tracking-tight text-[#3F95EC] dark:text-[#2e5bff]">
                            <svg
                                width="40"
                                height="auto"
                                viewBox="0 0 50 39"
                    ...
                    <form onSubmit={handleSubmit(submitForm)}>
                        ...
                        >
                            {loading ? (<LoaderCircle className="flex justify-self-center h-5 w-5 animate-spin" />) : "Sign Up"}
