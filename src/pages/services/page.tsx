import FeatureNotAvailableModal from "@/components/FeatureNotAvailable/modal";
import {
  BookOpenText,
  Bus,
  CableCar,
...
const ServicesPage = () => {
  const [FnaOpen, setFnaOpen] = useState(false);
  return (
    <>
      <main className="max-w-[1200px] mx-auto px-6 py-10 pb-20">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-on-surface-variant max-w-md text-lg leading-relaxed">
                Liquid finance at your fingertips. From utilities to travel,
                manage everything in one kinetic ecosystem.
              </p>
            </div>
        ...
        <section className="mb-14">
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="text-primary font-semibold text-sm cursor-pointer hover:underline">
              View All
            </span>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <NavLink
              to={"/topup"}
              className="col-span-2 row-span-2 bg-primary-fixed rounded-[2rem] p-8 flex flex-col justify-between overflow-hidden relative group cursor-pointer"
            >
              <div className="z-10">
                <span className="material-symbols-outlined text-4xl text-on-primary-fixed mb-4">
                  <Signal className="h-6 w-6" />
                </span>
                <h3 className="text-2xl font-bold text-on-primary-fixed">
                  Mobile TopUp
                </h3>
                <p className="text-on-primary-fixed-variant mt-2 text-sm max-w-[150px]">
                  Recharge any network instantly.
                </p>
              </div>
              <div className="absolute -right-8 -bottom-8 opacity-10 group-hover:scale-110 transition-transform duration-500">
                <span className="material-symbols-outlined text-[12rem]">
                  <Smartphone className="h-72 w-72" />
                </span>
              </div>
              <div className="z-10 mt-6">
                <button className="bg-on-primary-fixed text-white px-4 py-2 rounded-full text-xs font-bold">
                  RECHARGE NOW
                </button>
              </div>
            </NavLink>
            <button
              ...
              className="bg-surface-container-low hover:bg-surface-container-high transition-colors p-6 rounded-[2rem] flex flex-col items-center justify-center text-center cursor-pointer group"
            >
        ...
        <div className="space-y-16">
          <section>
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-lg font-bold uppercase tracking-widest text-on-surface-variant">
                Utilities
              </h2>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
              <div className="flex flex-col gap-3 group cursor-pointer">
                <div className="aspect-square bg-surface-container-low rounded-3xl flex items-center justify-center group-hover:bg-surface-container-high transition-colors">
                  <span className="material-symbols-outlined text-on-surface-variant group-hover:text-primary transition-colors text-3xl">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-[2.5rem] border border-outline-variant/10 hover:shadow-xl hover:shadow-on-surface/5 transition-all flex items-center gap-6 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant text-sm">
                    Pay your loan installments instantly.
                  </p>
                </div>
              </div>
              <div className="bg-surface-container-lowest p-6 rounded-[2.5rem] border border-outline-variant/10 hover:shadow-xl hover:shadow-on-surface/5 transition-all flex items-center gap-6 group cursor-pointer">
                ...
                <NavLink to={"/meroshare"}>
                  ...
                  <p className="text-on-surface-variant text-sm">
                    Renew your share accounts easily.
                  </p>
                </NavLink>
              </div>
              <div className="bg-surface-container-lowest p-6 rounded-[2.5rem] border border-outline-variant/10 hover:shadow-xl hover:shadow-on-surface/5 transition-all flex items-center gap-6 group cursor-pointer">
          ...
          <section>
            ...
            <div className="flex flex-nowrap overflow-x-auto gap-6 no-scrollbar pb-4">
              <NavLink
                to={"/travel"}
                className="min-w-[200px] bg-surface-container-low p-6 rounded-[2.5rem] flex flex-col items-center text-center group cursor-pointer hover:bg-surface-container-high transition-colors"
              >
                <span className="material-symbols-outlined text-4xl mb-4 text-on-surface-variant group-hover:text-primary">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <NavLink
                to={"/government"}
                className="bg-surface-container-lowest border border-outline-variant/20 p-5 rounded-3xl flex items-center gap-4 hover:border-primary transition-colors cursor-pointer group"
              >
